...
#define IPV6_ADDR(a, b, c, d, e, f, g, h) {{{ \
   MSB_CYCLONE(a), LSB_CYCLONE(a), MSB_CYCLONE(b), LSB_CYCLONE(b), MSB_CYCLONE(c), LSB_CYCLONE(c), MSB_CYCLONE(d), LSB_CYCLONE(d), \
   MSB_CYCLONE(e), LSB_CYCLONE(e), MSB_CYCLONE(f), LSB_CYCLONE(f), MSB_CYCLONE(g), LSB_CYCLONE(g), MSB_CYCLONE(h), LSB_CYCLONE(h)}}}
