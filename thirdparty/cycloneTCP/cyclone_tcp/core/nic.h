...
typedef void (*PhyEventHandlerIpv6)(NetInterface *interface);
...
typedef void (*UartTick)(NetInterface *interface);
typedef void (*UartEnableIrq)(void);
typedef void (*UartDisableIrq)(void);
typedef void (*UartStartTx)(NetInterface *interface);
...
typedef struct
{
   ...
   PhyEventHandlerIpv6 eventHandler;
